...
//             {/* SUPER ANIMATED FLOATING DROPDOWN CARD */}
//             <AnimatePresence>
//               {isDonateOpen && (
//                 <motion.div
...
//               className="lg:hidden absolute top-[115%] left-0 right-0 bg-white/98 dark:bg-slate-900/98 backdrop-blur-2xl border border-slate-200 dark:border-white/10 rounded-[2.5rem] p-6 max-h-[80vh] overflow-y-auto shadow-2xl origin-top"
//             >
...
//                     }}
//                     className="text-xl font-black text-slate-950 dark:text-white hover:text-[#EC9232] transition-colors py-1"
//                   >
//                     {link.name}
//                   </Link>
//                 ))}
...
//                   <button
//                     onClick={() => setIsDonateMobileOpen(!isDonateMobileOpen)}
//                     className="flex items-center justify-center gap-1 text-xl font-black text-slate-950 dark:text-white hover:text-[#EC9232] transition-colors py-2"
//                   >
//                     Donate
//                     <motion.span
...
//                     }}
//                     className="w-full overflow-hidden flex flex-col items-center gap-3 bg-slate-50 dark:bg-white/5 rounded-2xl transition-all duration-300"
//                     style={{ padding: isDonateMobileOpen ? "12px 0" : "0" }}
//                   >
...
//                             setIsDonateMobileOpen(false);
//                           }}
//                           className="flex items-center gap-3 w-4/5 text-sm font-bold text-slate-600 dark:text-slate-400 hover:text-[#EC9232] dark:hover:text-[#EC9232] transition-colors py-1.5"
//                         >
//                           <Icon
//                             size={16}
...
//                 <motion.button
//                   whileTap={{ scale: 0.95 }}
//                   className="w-full py-4 mt-2 bg-[#EC9232] text-white font-black rounded-2xl shadow-lg shadow-orange-500/20"
//                 >
//                   Join Oneness
//                 </motion.button>
//               </div>
